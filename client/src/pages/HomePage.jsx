...
const GlobalStyles = () => (
  <style>{`
    ...
    body::before {
      ...
      background: rgba(10, 20, 35, 0.7); /* A cooler, deeper overlay */
      z-index: -1;
    }
    ...
    /* Dynamic navbar style for when user scrolls */
    .scrolled-nav {
  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full flex flex-col items-center text-gray-200">
        {/* Header with dynamic class for scroll effect */}
        <header
          className={`w-full p-4 fixed top-0 z-50 transition-all duration-300 ${
            isScrolled ? "scrolled-nav" : ""
          }`}
        >
        ...
        <main className="flex-grow flex items-center justify-center p-4">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            >
              ...
              Wonders. Report, track, and witness the resolution of civic
              issues.
            </p>
            <div
